...
# Docker/Compose injecte ces variables (sinon local: pas de changement)
...
# CONFIG STREAMLIT
# ===============================
st.set_page_config(page_title="SécuTransac", layout="wide")
...
@st.cache_resource
def load_model():
    run_id = (MODELS_DIR / "latest_run_id.txt").read_text().strip()
    return mlflow.sklearn.load_model("models:/SecuTransac_Fraud_Model/latest")
...
CSV_FILE = DATA_DIR / "tested_transactions.csv"
